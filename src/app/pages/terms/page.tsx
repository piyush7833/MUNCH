...
const Page = () => {
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="prose">
        <p>
          Welcome to MUNCH! These terms and conditions outline the rules and regulations
          for the use of MUNCH Website, located at www.foodaggregator.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue
          to use MUNCH if you do not agree to take all of the terms and conditions stated
          on this page.
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, MUNCH and/or its licensors own the intellectual property
          rights for all material on MUNCH. All intellectual property rights are reserved.
          You may access this from MUNCH for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul className="list-disc pl-4">
          <li>Republish material from MUNCH</li>
          <li>Sell, rent or sub-license material from MUNCH</li>
          <li>Reproduce, duplicate or copy material from MUNCH</li>
          <li>Redistribute content from MUNCH</li>
        </ul>
        <p>
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of MUNCH; and (d) the link is
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to MUNCH. Please
        ...
        <p>
          No use of MUNCH logo or other artwork will be allowed for linking absent a
        ...
        <h2 className="text-xl font-semibold mt-4">Your Privacy</h2>
