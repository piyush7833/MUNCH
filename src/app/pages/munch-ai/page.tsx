...
const MUNCHAI = () => {
  ...
  return (
    <div className="main flex flex-col md:flex-row gap-14 md:gap-4 items-center justify-center hideScrollBar w-full">
      ...
      {res && visible && (
        <div className="main hideScrollBar w-full backdrop-blur-md absolute flex items-center justify-center">
          <div className="w-full h-fit md:w-1/2 flex items-center justify-center ">
            <div className="w-1/2 h-1/2 bg-white dark:bg-darkGradient2 rounded-md p-4 flex flex-col gap-4">
