...
const Slider = () => {
  ...
  const { userName,name } = userAuthStore();
    ...
    <div className="relative w-full h-[calc(100vh-5.5rem)] bg-inher overflow-hidden">
      ...
      >
        {items.map((item, index) => (
          <div
            key={index}
            className={`w-full h-[calc(100vh-5.5rem)] flex-shrink-0 relative transform transition-transform duration-500  ${
              ...
              <div className={`slider-card `}>
                ...
                <div className="content h-[calc(100vh-16rem)] w-4/5 md:w-1/2 bg-inherit items-start flex md:items-center">
                  <div className="h-2/3 md:h-3/6 flex flex-col  md:justify-evenly">
                    <div className="title text-2xl md:text-6xl text-orange-600">
                      {item.title}
                    </div>
                    <div className="subTitle text-base md:text-2xl text-orange-300">
                      {item.subtitle}
                    </div>
                    <br />
